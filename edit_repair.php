...
<head>
    ...
    <title>Edit Repair Case #<?= htmlspecialchars($repair['repair_id']) ?></title>
...
<body>
    <div class="container" style="max-width: 600px;">
        <div class="header">
            <h1>Edit Repair Case #<?= htmlspecialchars($repair['repair_id']) ?></h1>
        ...
        <div class="card">
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" id="gadget_type" name="gadget_type"
                        value="<?= htmlspecialchars($repair['gadget_type']) ?>" required>
                </div>
                <div class="form-group">
                    <label for="described_issue">Described Issue</label>
                    <textarea id="described_issue" name="described_issue" rows="6"
                        required><?= htmlspecialchars($repair['described_issue']) ?></textarea>
                </div>
